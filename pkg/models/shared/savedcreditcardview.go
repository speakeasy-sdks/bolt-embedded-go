...
// SavedCreditCardViewType - The payment method type. If empty, the property defaults to `card`.
type SavedCreditCardViewType string

const (
	SavedCreditCardViewTypeCard   SavedCreditCardViewType = "card"
	SavedCreditCardViewTypePaypal SavedCreditCardViewType = "paypal"
)

func (e SavedCreditCardViewType) ToPointer() *SavedCreditCardViewType {
	return &e
}

func (e *SavedCreditCardViewType) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "card":
		fallthrough
	case "paypal":
		*e = SavedCreditCardViewType(v)
		return nil
	default:
		return fmt.Errorf("invalid value for SavedCreditCardViewType: %v", v)
	}
}
